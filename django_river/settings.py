"""
Django settings for django_river project.
...
SECRET_KEY = 'h*b=qxfey=i%^=l0ix&u^zn5h1z^*2sbmvh0dwz@68=+qsv19+'
...
ROOT_URLCONF = 'django_river.urls'
...
WSGI_APPLICATION = 'django_river.wsgi.application'
